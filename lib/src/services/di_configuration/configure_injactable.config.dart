...
_i1.GetIt $configureInjactable(_i1.GetIt get,
  ...
  gh.singleton<_i8.Logger>(registerModule.logger, dispose: _i6.disposeLogger);
  gh.singleton<_i9.HttpService>(
      _i9.HttpService(get<_i5.Dio>(), get<_i8.Logger>()));
  gh.singleton<_i10.ArticleListLoader>(_i10.ArticleListLoader(
      get<_i8.Logger>(), get<_i4.ArticleListParser>(), get<_i9.HttpService>()));
  return get;
}
